import { generateWorld, predictSeats } from "./11";
...
it("simple 1a/2", () => {
  ...
  expect(world.stringify()).toMatchInlineSnapshot(`
    "#.##.##.##
    #######.##
    #.#.#..#..
    ####.##.##
...
it("solution 1/2", () => {
  expect(
    predictSeats(`LLLLLL.LLLLLL.LLLLL.LLLLLLLLLLLLLLL.LLLLLLL.LLLLL.L.LLLLLLL.LLLLLLLLLLLLLL.LLL.L.L.LLLLLLLLL.LLLLL
