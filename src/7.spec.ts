import {
  howManyCanContainAtLeastOneShinyGoldBag,
  howManyBagsAreRequired,
} from "./7";

it("simple 1/2", () => {
  expect(
    howManyCanContainAtLeastOneShinyGoldBag(`light red bags contain 1 bright white bag, 2 muted yellow bags.
...
it("solution 1/2", () => {
  expect(
    howManyCanContainAtLeastOneShinyGoldBag(`mirrored gold bags contain 3 light teal bags.
...
it("simple 2a/2", () => {
  expect(
    howManyBagsAreRequired(`light red bags contain 1 bright white bag, 2 muted yellow bags.
  dark orange bags contain 3 bright white bags, 4 muted yellow bags.
  bright white bags contain 1 shiny gold bag.
  muted yellow bags contain 2 shiny gold bags, 9 faded blue bags.
  shiny gold bags contain 1 dark olive bag, 2 vibrant plum bags.
...
it("simple 2b/2", () => {
  expect(
    howManyBagsAreRequired(`shiny gold bags contain 2 dark red bags.
...
it("solution 2/2", () => {
  expect(
    howManyBagsAreRequired(`mirrored gold bags contain 3 light teal bags.
    clear gold bags contain 5 light maroon bags, 4 pale tomato bags, 5 clear blue bags.
    dark olive bags contain 5 plaid black bags, 2 dim plum bags, 2 light cyan bags.
    bright white bags contain 2 pale violet bags, 5 mirrored orange bags, 3 faded beige bags.
    posh green bags contain 4 shiny gray bags.
